      ...
      <div className="py-10 ">
        <div className="md:flex md:justify-between md:items-center flex-none grid grid-cols-1 md:grid-cols-0 gap-2 ">
          <div className="ml-0 md:ml-6 md:mt-5 leading-relaxed">
            ...
            <a href="src/assets/files/Swastik-Mohapatra-Resume.pdf" target='_blank'>
              <button href="src/assets/files/Swastik-Mohapatra-Resume.pdf" target='_blank'  className=" bg-indigo-500 text-gray-100 p-3 text-sm  rounded-lg tracking-wide font-semibold  focus:outline-none focus:shadow-outline hover:bg-white hover:text-indigo-600 shadow-lg cursor-pointer transition ease-in duration-300"> 
                Download Resume
              </button>
              </a>
